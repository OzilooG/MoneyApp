...
export default function SavingsPage() {
  ...
  const arcPath =
    angle >= 360
      ...
      : angle === 0
        ? ""
        : `M110 110 L110 10 A100 100 0 ${angle > 180 ? 1 : 0} 1 ${
            110 + 100 * Math.sin((Math.PI * angle) / 180)
          } ${110 - 100 * Math.cos((Math.PI * angle) / 180)} Z`;

  return (
    <div
      className="min-h-screen w-full pb-28"
      style={{
        background: "linear-gradient(135deg, #5878FF 0%, #335BFF 50%, #102A9A 100%)",
      }}
    >
      {/* Header */}
          ...
          <div className="flex flex-col md:flex-row md:items-center md:gap-8">
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start mt-3">
                <button
                  onClick={() => speak(`You have saved ${savings.toFixed(2)} euro`)}
          ...
          {goal > 0 ? (
            ...
            >
              ...
              <svg width="180" height="180" viewBox="0 0 220 220">
                ...
                <text
                  ...
                  y="106"
                  textAnchor="middle"
                  style={{ fontSize: "22px", fontWeight: 900, fill: "#16a34a" }}
                >
                  {pct}%
                </text>
                <text
            ...
            >
              ...
              <p className="text-white/70 text-sm font-semibold text-center">
                Set a savings goal to see your progress here
              </p>
            </motion.div>
          )}
