...
export default function DashboardPage() {
  ...
  function handleSpeak() {
    setSpeaking(true);
    speak(
      `${greeting} ${userName}. You have €${balance.toLocaleString()} available. This month you earned €${income.toLocaleString()} and spent €${spent.toLocaleString()}.`
    );
  ...
  return (
    ...
    <div
      ...
      style={{
        background:
          "linear-gradient(135deg, #5878FF 0%, #335BFF 50%, #102A9A 100%)",
      }}
    >
            ...
            >
              <div className="w-full max-w-sm bg-white rounded-[2.2rem] p-8 shadow-2xl text-center">
                ...
                <p className="text-slate-500 text-sm mb-6">
                  Enter how much money you currently have to get started.
                </p>
                ...
                <button
                  ...
                  style={{
                    background: "linear-gradient(135deg, #5878FF, #335BFF)",
                    boxShadow: "0 4px 20px rgba(51,91,255,0.4)",
                  }}
                >
                  Let's go →
                </button>
                <p className="text-xs text-slate-400 mt-4">
                  Income and spending will update your balance automatically.
                </p>
              </div>
            </motion.div>
          </>
      ...
      >
        ...
        >
          ...
          <div className="flex justify-center mt-3">
            <button
              ...
              style={{
                background: speaking ? "#2e5bff" : "#eff6ff",
                color: speaking ? "#fff" : "#2e5bff",
          ...
          {income + spent > 0 && (
            <div className="mt-4 pt-3 border-t border-slate-100">
              ...
              <div className="flex h-4 rounded-full overflow-hidden gap-0.5">
                <div
                  className="flex items-center justify-end pr-2 rounded-l-full"
                  style={{
                    width: `${Math.round((income / (income + spent)) * 100)}%`,
                    background: "#16a34a",
                  }}
                >
                ...
                <div
                  className="flex items-center justify-start pl-2 rounded-r-full"
                  style={{
                    width: `${Math.round((spent / (income + spent)) * 100)}%`,
                    background: "#ea580c",
                  }}
                >
        ...
        <motion.div variants={fadeUp} className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <button
            onClick={() => setShowIncomePanel((v) => !v)}
              ...
              <div className="grid grid-cols-3 md:grid-cols-6 gap-2 mb-3">
                {[100, 200, 500, 1000, 1500, 2000].map((v) => (
                  <button
                    ...
                    style={{
                      background: incomeAmount === String(v) ? "#16a34a" : "#f0fdf4",
                      color: incomeAmount === String(v) ? "#fff" : "#16a34a",
          ...
          >
            ...
            <div className="p-5">
              <div className="flex justify-between items-center mb-3">
                ...
                <span
                  onClick={() => router.push("/spent")}
                  className="text-xs font-semibold text-blue-600 bg-blue-50 px-3 py-1 rounded-full cursor-pointer"
                >
                  View all
                </span>
              </div>
              <div className="flex items-baseline gap-2 mb-2">
                ...
                {budget > 0 && (
                  <span className="text-sm text-slate-400">of €{budget} budget</span>
                )}
              </div>
              {budget > 0 && (
                      ...
                      >
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-xs text-slate-400">
                            €{savings.toLocaleString()} / €{savingsGoal.toLocaleString()}
                          </span>
                        </div>
                        <div className="w-full h-3 bg-green-100 rounded-full overflow-hidden mb-1">
                          <motion.div
                            initial={{ width: 0 }}
                            animate={{ width: `${pct}%` }}
                            transition={{ duration: 0.9, ease: [0, 0, 0.2, 1], delay: 0.5 }}
                            className="h-full rounded-full"
